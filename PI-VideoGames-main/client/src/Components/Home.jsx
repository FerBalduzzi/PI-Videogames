    ...
    <div className="Fondo-Home">
      <div className="Barra-Superior">
        ...
        <Link to="/newvideogame">
          <button className="Crear-Video">Crear Video Juego</button>
        </Link>
      </div>
      ...
      <div>
        ...
        <select className="Selector" onChange={(e) => handleSort(e)}>
          <option className="fondo-selector" value="az">
            A-Z
          </option>
          <option className="fondo-selector" value="za">
            Z-A
          </option>
        </select>
        ...
        >
          ...
          {allGenres.map((g) => (
            <option className="fondo-selector" key={g} value={g}>
              {g}
            </option>
          ))}
        </select>
        ...
        <select className="Selector" onChange={(e) => handleSortRating(e)}>
          <option className="fondo-selector" value="Max-Min">
            Max a Min
          </option>
          <option className="fondo-selector" value="Min-Max">
            Min a Max
          </option>
        </select>
