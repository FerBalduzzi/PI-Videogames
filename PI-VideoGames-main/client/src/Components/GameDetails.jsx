      ...
      {aGame.length > 0 ? (
        <div className="Conte-General">
          ...
          <img
            ...
            src={aGame.map((el) => el.background_image)}
            alt=""
          />
          ...
          <div className="Conte-Sub">
            ...
            <p className="Conte-Plataform">
              {aGame && aGame.map((el) => el.plataforms.join(",  "))}
            </p>

            <h4 className="TituloGeneros">⚔ Generos : </h4>
            <p className="Conte-Generos">
              {aGame && aGame.map((el) => el.join(",  "))}
            </p>

            <h4 className="TituloDescripcion">📜 Descripción :</h4>
            <p className="Descripcion-Detalle">
              {aGame.map((el) => el.description)}
            </p>
          </div>
        </div>
      ) : (
        <div className="Conte-General">
          ...
          <div className="Conte-Sub">
            ...
            <div className="Conte-Plataform">
              {aGame.platforms && aGame.platforms.join(",  ")}
            </div>

            <h4 className="TituloGeneros">⚔ Generos :</h4>
            <div className="Conte-Generos">
              {aGame.genres && aGame.genres.join(",  ")}
            </div>
